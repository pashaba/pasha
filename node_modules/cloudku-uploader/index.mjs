...
export const parseExpireTime = (timeStr) => {
...
export const uploadFile = async (fileBuffer, fileName = 'image.jpg', expireDate = null) => {
...
export const uploadSmart = async (fileBuffer, fileName = 'image.jpg', expireTime = null) => {
    const expireDate = parseExpireTime(expireTime);
    return uploadFile(fileBuffer, fileName, expireDate);
};

export const uploadTemp = (fileBuffer, fileName, expireTime) => 
    uploadSmart(fileBuffer, fileName, expireTime);

export const uploadPermanent = (fileBuffer, fileName) => 
...
export const upload30s = (buffer, name) => uploadTemp(buffer, name, '30s');  
export const upload15m = (buffer, name) => uploadTemp(buffer, name, '15m');  
export const upload6h = (buffer, name) => uploadTemp(buffer, name, '6h');   
export const upload7d = (buffer, name) => uploadTemp(buffer, name, '7d');    
export const upload3M = (buffer, name) => uploadTemp(buffer, name, '3M');    
export const upload1y = (buffer, name) => uploadTemp(buffer, name, '1y');   
